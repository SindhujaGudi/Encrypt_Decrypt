...
public class XOR
{
 public static void encrypt(String strName,String key,String outputFileName) throws IOException
 {
  ...
  public static void main(String[] args) throws  IOException
  {
   ...
   do
   {       
    System.out.println("1.enter your name and a filename to save 2. enter a file name to load  3.Exit");
    option = sc.nextInt();
	 if( option == 1) {
	...
	XOR.encrypt(strName, strPassword, fileNameToSave);
   } else if ( option == 2 ) {
	System.out.println("Enter the filename to decrypt :");
	sc = new Scanner(System.in);
    fileNameToDec = sc.nextLine();
	XOR.decrypt(fileNameToDec,strPassword);
   } 
